<?php
  ...
  if($userData->image == "") { //setando imagem padrao
            ...
            <div class="row">
              <div class="col-md-4">
                ...
                <div class="form-group">
                  ...
                  <input type="text" readonly class="form-control disable" id="email" name="email" placeholder="Digite o seu sobrenome" value="<?= $userData->email ?>">
                </div>
